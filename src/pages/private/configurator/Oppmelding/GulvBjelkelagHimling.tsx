...
const formSchema = z.object({
  ...
  KommentarEtasjeskiller: z.string().optional(),
  BjelkelagForsterkesFølgende: z.string().optional(),
  Loft: z.string().optional(),
  KommentarLoft: z.string().optional(),
});
...
export const GulvBjelkelagHimling = forwardRef(
  (
    ...
    const BjelkelagMellomEtasjer = [
      "Ikke relevant for dette tiltak",
      "Standard utførelse",
      "Thermogulv «Ekstra» 25 mm",
      "Lydgulv iht. detalj nr. 251-110 fig. b",
      "Lydgulv Thermogulv 22x620x1820mm",
    ];
    const Loft = ["Ikke relevant for dette tiltak", "Standard utførelse"];
      ...
      <>
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <div className="flex flex-col md:grid md:grid-cols-2 desktop:grid-cols-3 gap-4 md:gap-5">
                              {BjelkelagMellomEtasjer.map((option) => (
                                <div
                                  key={option}
                                  className="relative flex items-center gap-2 cursor-pointer"
                                  onClick={() => {
                                    form.setValue(
                                      "BjelkelagMellomEtasjer",
                                      option
                                    );
                                  }}
                                >
        ...
        ${
          fieldState?.error ? "border-red" : "border-gray1"
                                    ...
                                    value={option}
                                    onChange={(e) => {
                                      form.setValue(`Loft`, e.target.value);
                                    }}
                                    checked={field.value === option}
                                  />
                                  <p className={`text-black text-sm`}>
