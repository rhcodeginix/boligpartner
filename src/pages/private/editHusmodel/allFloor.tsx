        ...
        <>
          <div className="py-4 px-4 md:px-6 bg-lightGreen">
            ...
            <div className="flex items-center justify-between gap-2 md:gap-3">
              <div className="flex flex-col gap-2">
                ...
                <div className="w-full max-w-[700px] h-[100px] rounded-lg custom-shimmer"></div>
              </div>
              <div className="w-[120px] h-[120px] rounded-lg custom-shimmer"></div>
            </div>
          </div>
          <div className="flex flex-col lg:flex-row gap-4 desktop:gap-6 px-4 md:px-6 pt-6 pb-[136px]">
            ...
            <div className="w-full lg:w-[70%] desktop:w-[75%] border border-[#EFF1F5] rounded-lg overflow-hidden h-max p-3">
              <div className="w-full h-[400px] lg:h-[690px] rounded-lg custom-shimmer"></div>
            </div>
          </div>
        </>
      ) : (
            ...
            <div className="flex items-center justify-between gap-2 md:gap-3">
              <div className="flex flex-col gap-2">
                ...
                <p className="text-secondary text-sm md:text-base desktop:text-lg">
                  ...
                  eksisterende. Har legger du inn valg for gulv, vegg, himling
                  og listverk for de ulike rommene på planet.
                </p>
              </div>
              {activeTabData !== null && (
                <img
