        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <div>
            ...
            <div className="py-3 md:py-5">
              <div className="flex items-center gap-4 md:gap-6 h-[48px] mb-8 border border-[#EFF1F5] rounded-lg bg-[#F9F9FB] p-2">
          ...
          <div
            className="flex flex-wrap justify-end w-full gap-3 md:gap-5 items-center fixed bottom-0 bg-white border-t border-gray2 p-4 left-0"
            style={{
              zIndex: 99999,
            }}
          >
                    ...
                    const updatedPlantegninger = (
                      ...
                      if (String(item.pdf_id) === String(pdfId)) {
                        const merged = removeUndefined(
                          deepCompareAndMerge(item, rooms)
                        );
                        return { ...item, ...merged, id, configurator: true };
                      }
                      return item;
                    });
