...
}> = ({ onClose, onSubmit: onSubmitProp, defaultValues }) => {
  const form = useForm<z.infer<typeof formSchema>>({
    resolver: zodResolver(formSchema),
  });
  useEffect(() => {
    if (defaultValues) {
      form.setValue("Hovedbilde", defaultValues?.Hovedbilde);
      form.setValue("IncludingOffer", defaultValues?.IncludingOffer);
      form.setValue("Labour", defaultValues?.Labour);
      form.setValue("LabourPris", defaultValues?.LabourPris);
      form.setValue("Produktbeskrivelse", defaultValues?.Produktbeskrivelse);
      ...
      <Form {...form}>
        ...
        >
          <div className="overflow-y-auto h-full pb-[160px]">
            <div className="flex flex-col gap-[18px] p-4 bg-white border border-[#DCDFEA]">
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <FormField
                    ...
                    render={({ field, fieldState }) => {
                      const initialValue = form.getValues(`Produktnavn`) || "";
                      return (
                        <FormItem>
                          <p
                            className={`${
                ...
                <div>
                  <FormField
                    ...
                    name={`pris`}
                    render={({ field, fieldState }) => {
                      const initialValue = form.getValues(`pris`);
                      return (
                        <FormItem>
                            ...
                            <div className="flex items-center gap-3 text-black text-sm font-medium">
                              ...
                              <div className="toggle-container">
                                <input
                                  ...
                                  checked={
                                    form.watch(`IncludingOffer`) || false
                                  }
                                  name={`IncludingOffer`}
                                  onChange={(e: any) => {
                          ...
                          <FormControl>
                            <div className="relative">
                              <Input
                                ...
                                inputMode="numeric"
                                disable={form.watch(`IncludingOffer`)}
                                type="text"
                          ...
                          <div className="flex items-center gap-5">
                            {delieverBy.map((option) => (
                              <div
                                ...
                                onClick={() => {
                                  form.setValue("delieverBy", option);
                                }}
                              >
                                <input
                                  className={`bg-white rounded-[8px] border text-black
        ${
          fieldState?.error ? "border-red" : "border-gray1"
                                  ...
                                  value={option}
                                  onChange={(e) => {
                                    form.setValue(`delieverBy`, e.target.value);
                                  }}
        ...
        ${
          fieldState?.error ? "border-red" : "border-gray1"
                                  ...
                                  value={option}
                                  onChange={(e) => {
                                    form.setValue(`Labour`, e.target.value);
                                  }}
                                  checked={field.value === option}
                                />
                                <p className={`text-black text-sm`}>{option}</p>
                ...
                <div>
                  <FormField
                    ...
                    name={`LabourPris`}
                    render={({ field, fieldState }) => {
                      const initialValue = form.getValues(`LabourPris`);
                      return (
                        <FormItem>
                          <p
                            className={`${
                ...
                <div className="col-span-2">
                  <FormField
                    ...
                    render={({ field, fieldState }) => {
                      const initialValue =
                        form.getValues(`Produktbeskrivelse`) || "";
                      return (
                        <FormItem>
                          <p
                            className={`${
                ...
                <div className="row-span-2">
                  <FormField
                    ...
                    name={`Hovedbilde`}
                    render={({ fieldState }) => {
                      const fieldPath: any = `Hovedbilde`;
                    ...
                    {upload3DPhoto?.map((file: any, imgIndex: number) => (
                      <div
                        ...
                        onDrop={() => {
                          ...
                          form.setValue(`Hovedbilde`, newOrder);
                      ...
                      >
                        ...
                        <div
                          ...
                          onClick={() => {
                            ...
                            form.setValue(`Hovedbilde`, updatedFiles);
                          }}
                        >
